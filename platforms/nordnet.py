...
class Nordnet(Platform):
    ...
    def get_account_value(self):
        try:
            ...
            portfolio_today = self.browser.getElement(self.By.CLASS_NAME, 'hcICEi')
    ...
    def get_available_funds(self):
        try:
            ...
            available_funds_container = self.browser.getElement(self.By.CLASS_NAME, 'erVdue')
            available_funds_element = available_funds_container.find_element_by_class_name('jILKmC')
